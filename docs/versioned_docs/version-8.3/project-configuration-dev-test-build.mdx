...
For those well-versed in Babel config, you can find Redwood's in [@redmix/internal](https://github.com/redmix-run/redmix/tree/main/packages/internal/src/build/babel).
...
> You can always see Redwood's latest configuration templates in the [create-redwood-app package](https://github.com/redmix-run/redmix/blob/main/packages/create-redwood-app/templates/ts/web/jest.config.js).
...
You can find all the details in the [source](https://github.com/redmix-run/redmix/blob/main/packages/testing/config/jest/web/jest-preset.js).
...
You can find all the details in the [source](https://github.com/redmix-run/redmix/blob/main/packages/testing/config/jest/api/jest-preset.js).
...
>
> You can grab the latest launch.json from the Redwood template [here](https://github.com/redmix-run/redmix/blob/main/packages/create-redwood-app/templates/ts/.vscode/launch.json). Copy the contents into your project's `.vscode/launch.json`
