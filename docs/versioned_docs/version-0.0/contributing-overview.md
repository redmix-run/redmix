...
| [`@redmix/create-redmix-app`](https://github.com/redmix-run/redmix/blob/main/packages/create-redmix-app/README.md) | Enables `yarn create redmix-app`&mdash;downloads the latest release of Redwood and extracts it into the supplied directory                                                                                  |
