...
We refer to the codebase of a Redwood application as a Project. This is what you install when you run `yarn create redmix-app <path-to-directory>`. It’s the thing you are building with Redwood.
