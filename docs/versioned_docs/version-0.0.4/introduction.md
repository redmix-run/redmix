...
For full inspiration and vision, see Redwood's [README](https://github.com/cedarjs/cedar/blob/main/README.md).

Development on Cedar happens in the [cedarjs/cedar repo on GitHub](https://github.com/cedarjs/cedar).
The docs are [there too](https://github.com/cedarjs/cedar/tree/main/docs).
While the [Cedar Team](https://github.com/cedarjs/cedar#the-cedar-team)
handle most of the high-priority items and the day-to-day, Cedar wouldn't be
