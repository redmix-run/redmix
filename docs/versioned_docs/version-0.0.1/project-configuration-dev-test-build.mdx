...
> You can always see Redwood's latest configuration templates in the [create-redmix-app package](https://github.com/redmix-run/redmix/blob/main/packages/create-redmix-app/templates/ts/web/jest.config.js).
...
>
> You can grab the latest launch.json from the Redwood template [here](https://github.com/redmix-run/redmix/blob/main/packages/create-redmix-app/templates/ts/.vscode/launch.json). Copy the contents into your project's `.vscode/launch.json`
