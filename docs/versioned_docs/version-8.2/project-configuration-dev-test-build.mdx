...
For those well-versed in Babel config, you can find Redwood's in [@redmix/internal](https://github.com/redwoodjs/redwood/tree/main/packages/internal/src/build/babel).
