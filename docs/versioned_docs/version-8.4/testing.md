...
```jsx
import { ParamsProvider } from '@redmix/router';
...
```jsx {1,6-8}
import { routes } from '@redmix/router'
...
```jsx title="web/src/pages/HomePage/HomePage.test.js"
import { render, screen, waitFor } from '@redmix/testing/web'
import HomePage from './HomePage'
...
import { renderHook } from '@redmix/testing/web'
...
```ts
// highlight-next-line
import { partialMatch } from '@redmix/testing/cache'
