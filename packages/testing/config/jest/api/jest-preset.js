...
const { getApiSideDefaultBabelConfig } = require('@redmix/babel-config')
...
module.exports = {
  ...
  moduleNameMapper: {
    // @NOTE: Import @redmix/testing in api tests, and it automatically remaps to the api side only
    // This is to prevent web stuff leaking into api, and vice versa
    '^@redmix/testing$': path.join(NODE_MODULES_PATH, '@redmix/testing/api'),
  },
  transform: {
    '\\.[jt]sx?$': [
      'babel-jest',
