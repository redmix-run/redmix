...
export const updateDevFatalErrorPage = async () => {
  ...
  const url =
    'https://raw.githubusercontent.com/redwoodjs/redwood/29138f59dc5abe7b3d3c2a11c6e6f5fee32580c5/packages/create-redmix-app/templates/ts/web/src/pages/FatalErrorPage/FatalErrorPage.tsx'
