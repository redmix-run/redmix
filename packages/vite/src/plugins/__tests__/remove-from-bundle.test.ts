...
describe('excludeModule', () => {
  it('should return true if idToExclude matches id', () => {
    const loadOutput = excludeOnMatch(
      ...
      '/Users/dac09/Experiments/splash-page-null-loader/node_modules/@redmix/router/dist/splash-page.js?commonjs-exports',
    )
  ...
  it("should return false if idToExclude doesn't match id", () => {
    const loadOutput = excludeOnMatch(
      [{ id: /bazinga-page/ }],
      '/Users/dac09/Experiments/splash-page-null-loader/node_modules/@redmix/router/dist/params.js',
    )
