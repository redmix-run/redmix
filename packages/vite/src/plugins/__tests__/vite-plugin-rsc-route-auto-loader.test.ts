...
describe('rscRoutesAutoLoader', () => {
  it('should insert the correct imports for non-ssr', async () => {
    ...
    // - The import of `dummyComponent` from `@cedarjs/router/dist/dummyComponent`
    expect(output).toMatchInlineSnapshot(`
      ...
      import ScaffoldLayout from "@cedarjs/router/dist/dummyComponent";
      import NotFoundPage from "./pages/NotFoundPage/NotFoundPage";
      const Routes = () => {
  ...
  it('should insert the correct imports for ssr', async () => {
    ...
    // Dummy imports (`import SomeWrapper from "@cedarjs/router/dist/dummyComponent"`)
